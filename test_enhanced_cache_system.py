...
class EnhancedCacheSystemTester:
    ...
    async def test_detection_result_caching(self):
        ...
        try:
            ...
            retrieval_success = cached_result is not None and len(cached_result.get("objects", [])) > 0
            self.log_test_result(
    ...
    async def test_extraction_result_caching(self):
        ...
        try:
            ...
            retrieval_success = cached_result is not None and "extracted_image_url" in cached_result
            self.log_test_result(
    ...
    async def test_natural_elements_caching(self):
        ...
        try:
            ...
            retrieval_success = (cached_result is not None and 
                               "vegetation_coverage" in cached_result and
                               cached_result["vegetation_coverage"] == 65.5)
    ...
    async def test_batch_processing_caching(self):
        ...
        try:
            ...
            retrieval_success = (cached_status is not None and 
                               cached_status.get("batch_id") == batch_id and
                               cached_status.get("progress_percentage") == 40.0)
    ...
    async def test_version_management(self):
        ...
        try:
            ...
            version_info = await cache_service.get_cache_version_info("detection_results")
            
            version_info_success = (version_info.get("enabled", False) and 
                                  "version_counts" in version_info)
    ...
    async def test_detailed_cache_statistics(self):
        ...
        try:
            ...
            stats_success = (detailed_stats.get("enabled", False) and
                           "redis_info" in detailed_stats and
                           "application_stats" in detailed_stats and
                           "type_statistics" in detailed_stats and
                           "performance_metrics" in detailed_stats)
            ...
            metrics_success = ("cache_efficiency_score" in perf_metrics and
                             "memory_efficiency" in perf_metrics)
    ...
    async def test_cache_warming(self):
        ...
        try:
            ...
            warming_success = (warming_stats.get("total_images", 0) == 3 and
                             "operations_attempted" in warming_stats)
    ...
    async def test_cache_cleanup(self):
        ...
        try:
            ...
            cleanup_success = ("total_keys_before" in cleanup_stats and
                             "total_keys_after" in cleanup_stats)
    ...
    async def test_lru_eviction(self):
        ...
        try:
            ...
            eviction_success = ("memory_before_mb" in eviction_stats and
                              "eviction_needed" in eviction_stats)
