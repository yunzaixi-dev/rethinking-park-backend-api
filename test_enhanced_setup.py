...
def test_enhanced_setup():
    ...
    try:
        ...
        print(f"   ✅ Enhanced Vision Service enabled: {enhanced_vision_service.is_enabled()}")
        
        # Test annotation service basic functionality
        test_colors = image_annotation_service.default_colors
        print(f"   ✅ Image Annotation Service default colors: {len(test_colors)} configured")
    ...
    try:
        ...
        print(f"   ✅ Google Cloud Project: {'Configured' if settings.GOOGLE_CLOUD_PROJECT_ID else 'Not configured'}")
