...
class FaceDetectionService(VisionService):
    ...
    def assign_face_ids(self, faces: List[FaceDetectionResult]) -> List[FaceDetectionResult]:
        """
    ...
    def anonymize_face_data(self, faces: List[FaceDetectionResult]) -> List[FaceDetectionResult]:
        """
