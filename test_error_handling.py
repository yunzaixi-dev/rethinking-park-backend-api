...
def test_error_classification():
    ...
    vision_error = VisionAPIException("Rate limit exceeded", error_code="429", retry_after=5)
    ...
    processing_error = ProcessingException("Image extraction failed", "extraction", recoverable=True)
    error_info = handle_processing_error(processing_error, "extraction", image_hash="test_hash")
...
def test_error_recovery_manager():
    ...
    test_errors = [
        ...
        BatchProcessingException("Partial batch failure", [{"id": "1", "error": "timeout"}], [{"id": "2", "result": "success"}])
    ]
...
def test_batch_error_handling():
    ...
    partial_results = [
        ...
        {"operation_id": "op_4", "result": {"objects": [{"name": "tree"}], "faces": []}}
    ]
